...
function cargar(){
fetch("http://localhost/datos/view/v_datos.php")
.then(reponse=>reponse.json())
.then(data=>{
console.log(data);
let medida=data.length;
document.getElementById('tablaDatos').innerHTML= document.getElementById('tablaDatos').innerHTML ='';
...
document.getElementById('tablaDatos').innerHTML= document.getElementById('tabladatos').innerHTML + carta;
}
});
}
document.getElementById('Grecep').addEventListener("click",()=>{
  ...
  formulario.append('fe',document.getElementById('fer').value);
  ...
  formulario.append('dep',document.getElementById('dep').value);

  let respon=fetch("http://localhost/datos/view/v_datos.php",{
    method:"POST",
    body:formulario
